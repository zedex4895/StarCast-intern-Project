...
const CastingPage = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      if (file.size > 5 * 1024 * 1024) {
        alert(
          "Image size should be less than 5MB. Please use a URL instead or compress the image."
        );
        return;
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Audition created successfully! It will be pending admin approval."
      );
      setShowForm(false);
      setFormData({
        title: "",
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <div className="text-sm text-gray-500 mt-2">
              Click "Create New Audition" to get started
            </div>
          </div>
        ) : (
                          ...
                          <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                            ...
                            <tbody className="divide-y divide-gray-200">
                              {registrations.map((registeredUser, index) => {
                                const profilePhoto =
                                  registeredUser.user?.profilePhoto ||
                                ...
                                const userDob =
                                  registeredUser.user?.dob ||
                                  registeredUser.dob;
                                const userAge =
                                  registeredUser.user?.age ||
                                  registeredUser.age;
                                const userAddress =
                                  registeredUser.user?.address ||
                                  ...
                                  >
                                    <td className="px-4 py-4 whitespace-nowrap">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div
                                          className={`w-12 h-12 rounded-full bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center border-2 border-gray-300 ${
                                            profilePhoto &&
                                            profilePhoto.trim() !== "" &&
                                            profilePhoto !== "null"
                                              ? "hidden"
                                          ...
                                          onClick={() => {
                                            const modal =
                                              document.getElementById(
                                                `media-modal-${registeredUser._id}`
                                              );
                                            if (modal)
                  ...
                  registrations.map((registeredUser) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={(e) => {
                          if (
                            e.target.id === `media-modal-${registeredUser._id}`
                          ) {
                        ...
                        <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                          <div className="flex justify-between items-center mb-4">
                            <h3 className="text-xl font-semibold">
                              Media from{" "}
                              {registeredUser.user?.name || registeredUser.name}
                            </h3>
                            <button
                              onClick={() => {
                            ...
                            <div>
                              ...
                              <div className="space-y-3">
                                {videos.map((video, videoIndex) => (
                                  <div
                                    key={videoIndex}
                                    className="border rounded overflow-hidden bg-black"
                                  >
                                    <video
                                      src={video}
                                      controls
